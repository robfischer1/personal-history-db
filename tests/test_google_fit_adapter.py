...
from phdb.plugins.google_fit import GoogleFitPlugin
...
def _new_plugin() -> GoogleFitPlugin:
    from phdb.core.plugin.manifest import load_manifest
    manifest_path = Path("src/phdb/plugins/google_fit/plugin.toml").resolve()
    manifest = load_manifest(manifest_path)
    return GoogleFitPlugin(manifest)
